...
export class EmployeeService {
  ...
  private serviceFeeView =
    environment.rootpathh + 'view/View_serviceFee_services';
  private addEmployeee =
  ...
  private measurementfeeaddd =
    environment.rootpathh + 'Measurement_Fee/procMeasurement_Fee';
  private serviceblockaddd =
    environment.rootpathh +
    'Service_Block_Registration/procService_Block_Registration';
  ...
  private woredaidaddd =
    environment.rootpathh + 'Woreda_Lookup/procWoreda_Lookup';
  private annualplanaddd =
  ...
  private subCityListt =
    environment.rootpathh + 'organizations/procorganizations';
  private sTransactionSalesTypes =
    environment.rootpathh +
    'S_Transaction_Sales_Type/procS_Transaction_Sales_Type';
  ...
  sTransactionSalesTypess(data: any): Observable<any> {
    return this._http.post(this.sTransactionSalesTypes, data);
  }
  ...
  sTransactionSalesTypessupdate(data: any): Observable<any> {
    return this._http.put(this.sTransactionSalesTypes, data);
  }
  ...
  sTransactionSalesTypeslist(): Observable<any> {
    return this._http.get(this.sTransactionSalesTypes);
  }
  ...
  servicedetaildelete(id: any): Observable<any> {
    ...
    return this._http.delete(
      this.servicedetailaddd + '/' + id.planID + '/' + id.sdpid
    );
  }
